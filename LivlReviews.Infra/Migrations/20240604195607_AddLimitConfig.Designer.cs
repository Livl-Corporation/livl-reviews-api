...
namespace LivlReviews.Infra.Migrations
{
    ...
    [Migration("20240604195607_AddLimitConfig")]
    partial class AddLimitConfig
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LivlReviews.Domain.Entities.LimitConfig", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("MaxRequestsPerUser")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("LivlReviews.Domain.Entities.LimitConfig", b =>
                {
                    b.HasOne("LivlReviews.Infra.Data.User", "AdminUser")
                        .WithOne("LimitConfig")
                        .HasForeignKey("LivlReviews.Domain.Entities.LimitConfig", "AdminUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
